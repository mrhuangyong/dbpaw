...
export const ja: Translations = {
  ...
  settings: {
    ...
    shortcuts: {
      title: "ショートカット",
      hint: "「記録」をクリックして新しいキーを押してください。新しい割り当てには修飾キー（Cmd / Ctrl / Alt / Shift）が必要です。",
      ...
      resetOne: "リセット",
      resetAll: "すべて初期化",
      resetAllConfirm: "すべてのショートカットを初期値に戻しますか？",
      confirmResetAll: "初期化",
      disable: "無効化",
      enable: "有効化",
      disabled: "無効",
      ...
      label: {
        openSettings: "設定を開く",
        toggleAiSidebar: "AIサイドバーの切り替え",
        toggleMainSidebar: "メインサイドバーの切り替え",
        newQueryTab: "新しいクエリタブを作成",
        closeTab: "現在のタブを閉じる",
        nextTab: "次のタブ",
        prevTab: "前のタブ",
        execute: "SQLを実行",
        saveQuery: "クエリを保存",
        format: "SQLを整形",
        acceptCompletion: "補完を確定 / タブを挿入",
        saveChanges: "未保存の変更を保存",
        openSearch: "テーブル検索を開く",
        copySelection: "選択行をコピー",
        cancelEdit: "編集をキャンセル / 未保存の変更を破棄",
      },
    },
    about: {
      title: "情報",
    ...
    sync: {
      ...
      configured: "同期が設定され有効になりました",
      configureFailed: "同期の設定に失敗しました",
      enterPassword: "同期パスワードを入力してください",
      synced: "同期完了：{{action}}",
      syncFailed: "同期に失敗しました",
      syncNow: "今すぐ同期",
      forcePush: "強制アップロード",
      forcePull: "強制ダウンロード",
      forcePushed: "リモートに強制アップロードしました",
      forcePushFailed: "強制アップロードに失敗しました",
      forcePulled: "リモートから強制ダウンロードしました",
      forcePullFailed: "強制ダウンロードに失敗しました",
      disabled: "同期を無効にしました",
      disableFailed: "同期の無効化に失敗しました",
      status: "同期ステータス",
      lastSync: "最終同期",
      noSyncYet: "未同期",
      syncInterval: "自動同期間隔",
  ...
  connection: {
    ...
    connectionImportDialog: {
      title: "データベース接続をインポート",
      description: "インポート元を選択してください",
      navicat: "Navicat",
      navicatDescription: ".ncx ファイルをインポート",
      navicatFormat: "XML 形式",
      dbeaver: "DBeaver",
      dbeaverDescription: ".json ファイルをインポート",
